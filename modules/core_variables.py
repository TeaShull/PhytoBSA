...
class VCFGenVariables:
    __slots__ = ['log', 'lines', 'reference_genome_path', 
        ...
        'cleanup_filetypes', 'reference_chrs_path'
    ]
    ...
    def __init__(self, logger,
        ...
        self.reference_chrs_path = None #generated in core_vcf_gen
    ...
    def gen_vcf_output_paths(self, name, vcf_ulid):
        ...
        try:
            ...
            raise
    def get_ref_name(self, file_path):
    ...
    def get_ref_path(self, ref_genome_path):
